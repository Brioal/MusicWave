 ...
 */
public class WaveRenderer implements WaveFromRenderer {
    ...
    private WaveRenderer(@ColorInt int backgroundColor, Paint foregroundPaint, Path waveformPath) {
        mBackgroundColor = backgroundColor;
        mForegroundPaint = foregroundPaint;
        mWaveformPath = waveformPath;
    }

    public static WaveRenderer newInstance(@ColorInt int backgroundColor, @ColorInt int foregroundColour) {
        ...
        return new WaveRenderer(backgroundColor, paint, waveformPath);
    }
